...
public class SamplerBlock extends AbstractSynthBlock<SamplerSynth> {
    private static final MapCodec<SamplerBlock> CODEC = simpleCodec(SamplerBlock::new);
    ...
    @Override
    protected @NonNull MapCodec<SamplerBlock> codec() {
        return CODEC;
    }
